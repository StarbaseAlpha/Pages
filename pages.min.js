"use strict";function Pages(db,parentPath="pages",container=null,callback){const component=document.createElement("div");component.classList.add("component"),component.classList.add("editor"),component.innerHTML=`
<form method="POST">
<div>
